...
function StrategyPanel({ strategy }: { strategy: PaperStrategyStatus }) {
  ...
  return (
    <section className="panel-mini strategy-block">
      ...
      <DemoTable title="Pending Orders" rows={strategy.pending_orders} columns={isSideways ? ["strategy", "symbol", "signal_date", "target_allocation", "base_duration", "base_range_max", "base_high", "base_low", "target_price"] : ["strategy", "symbol", "signal_date", "target_allocation", "liquidity_cap", "down_market_capture_60d"]} />
      <DemoTable title="Executed Orders" rows={strategy.order_ledger} columns={isSideways ? ["strategy", "symbol", "signal_date", "target_allocation", "base_duration", "base_range_max", "base_high", "base_low", "target_price"] : ["strategy", "symbol", "signal_date", "target_allocation", "liquidity_cap", "down_market_capture_60d"]} />
      <DemoTable title="Open Positions" rows={strategy.open_positions} columns={isSideways ? ["strategy", "symbol", "entry_date", "shares", "entry_price", "base_high", "base_low", "target_price", "bars_held"] : ["strategy", "symbol", "entry_date", "shares", "entry_price", "stop_price", "target_price", "bars_held"]} />
      <DemoTable title="Closed Orders" rows={strategy.closed_trades} columns={["strategy", "symbol", "entry_date", "exit_date", "reason", "shares", "pnl_value", "pnl_pct", "realized_move_pct"]} />
    </section>
  );
}
