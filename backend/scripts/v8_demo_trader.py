...
def run_demo(args: argparse.Namespace) -> None:
    ...
    filled = [] if intraday_enabled else broker.process_pending_entries(candles_by_symbol, as_of_date)
    closed = [] if intraday_enabled else broker.process_exits(candles_by_symbol, as_of_date)
