...
DEFAULT_V8_DEMO_DIR = Path(os.environ.get("V8_DEMO_OUTPUT_DIR", r"D:\app\data\exports\v8_demo_trader"))
DEFAULT_UPTREND_SIDEWAYS_DIR = Path(
    os.environ.get("UPTREND_SIDEWAYS_OUTPUT_DIR", r"D:\app\data\exports\uptrend_sideways_paper_trader")
)
