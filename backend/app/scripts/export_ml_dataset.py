...
def export_ml_dataset(output_path: str | None = None, settings: Settings | None = None) -> dict[str, Any]:
    if settings is None:
        settings = Settings()

    if output_path is None:
        # Default inside container
        output_path = "/app/data/exports/ml_dataset_ohlcv_v1.csv"
                ...
                for row in rows:
                    ...
                    for i, candle in enumerate(candles):
                        ...
                        for rk in REQUIRED_KEYS:
                            ...
                            if val is None:
                                null_count += 1
                                raise ValueError(f"Null value for {rk} in candle {i} for {symbol} {sample_date}")
...
if __name__ == "__main__":
    print("Starting ML dataset export...")
